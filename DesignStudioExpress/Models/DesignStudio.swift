...
class DesignStudio: Object {
    ...
    // creates a deep copy of the object and saves it
    ...
    class func createDefaultTemplate1() {
        do {
            ...
            print("Couldn't create a default template #1" + error.localizedDescription)
        }
    }
    ...
    class func createDefaultTemplate2() {
        do {
            ...
            print("Couldn't create a default template #2" + error.localizedDescription)
        }
    }
